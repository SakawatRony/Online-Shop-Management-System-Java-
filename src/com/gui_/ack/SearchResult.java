...
public class SearchResult implements ActionListener {
	...
	String password = "";
	String[] columnNames = { "uname", "pasword", "name", "phone","address" };
	...
	public void showTableData() {
		...
		try {
			...
			String sql = "select * from signup where name = " + textvalue;
			...
			if (rs.next()) {
				...
				model.addRow(new Object[] { uname, password, name, phone, address });
				i++;
			}
			if (i < 1) {
